...
//	@PostMapping("/login")
//	public ResponseEntity<?> authenticateAdmin(@RequestBody Admin admin) throws AppException
//	{
//		try {
//			String email = admin.getEmail();
//			String password = admin.getPassword();
//			
////			Customer cust = icust.authenticateCustomer(email, password);
//			AdminDTO ad = adminServices.getAdminDetails(email, password);
//			
//			if(ad != null)
...
//	@PutMapping("/update")
//	 public ResponseEntity<?> updateVendor(@RequestBody ServiceProvider vendor) throws AppException
//		{  
//			
//			try
//			{
//				
//	         ServiceProvider isRegistered = adminServices.saveServiceProvider(vendor);
//	         
//	         if(isRegistered != null)
//	        	 return new ResponseEntity<>(HttpStatus.OK);  	 
//	         else
//	     		throw new AppException("Invalid Vendor update Data");
//	         
//			}
//			catch(Exception e)
//			{
