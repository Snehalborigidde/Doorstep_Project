...
//	@Override
//	public Customer authenticateCustomer(String email, String password) throws AppException 
//	{
//		// TODO Auto-generated method stub
...
//		
////		Optional<Customer> optCust = icustdao.findByEmailAndPassword(username, password) ;
////		Customer custServ = optCust.
////				orElseThrow(() -> new AppException("Service Povider Not Found!!!"));
