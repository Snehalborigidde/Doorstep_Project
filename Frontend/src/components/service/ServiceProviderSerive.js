...
const SERVICEPROVIDER_API_BASE_URL = 'http://localhost:7070/admin'
...
class ServiceProviderSerive {
  ...
  getServiceByServiceType(serviceType) {
    return axios.get('http://localhost:7070/provider/' + serviceType)
  }
  ...
  bookService(vendorId) {
    ...
    return axios.post('http://localhost:7070/book', body)
  }


  getHistory(custId){
    return axios.get('http://localhost:7070/History/' + custId)
  }
  // getServiceByServiceType(serviceType) {
